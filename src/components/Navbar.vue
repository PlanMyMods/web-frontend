<template>
  <div>
    <div class="md:hidden">
      <nav class="bg-gray-50 border-gray-200 px-2 sm:px-4 p-2.5 dark:bg-gray-800 grid grid-cols-3 ">
      ...
      <!-- nav menu -->
      <div class="py-2.5 px-8 w-full md:hidden md:w-auto bg-gray-50 dark:bg-gray-800"
        ...
        <ul
          ...
          <li>
            <NavbarButtons linkRoute="/modules" linkName="Modules" />
          </li>
          <li>
      ...
      <!-- searchbar -->
      <Searchbar dropdownID="navbarDropdown" buttonID="navbarButton" searchID="navbarSearch"
        :class="{ hidden: showSearchBar === false }" />
    </div>
  </div>
...
export default {
  setup() {
    ...
    return { showNavMenu, showSearchBar };
  },
  components: {
    Button: Button,
    NavbarButtons,
